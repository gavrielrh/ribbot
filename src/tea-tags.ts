...
const TYPE_PATTERNS: Record<string, string[]> = {
  black: [
    "black tea", "breakfast", "assam", "darjeeling", "ceylon", "earl grey",
    "english breakfast", "keemun", "lapsang", "yunnan", "dianhong", "congou",
    "chai", "hao ya",
  ],
  green: [
    "green tea", "sencha", "gunpowder", "dragonwell", "longjing", "gyokuro",
    "genmaicha", "hojicha", "kukicha", "bancha", "bi luo chun",
  ],
  oolong: [
    "oolong", "wulong", "dong ding", "tieguanyin", "da hong pao", "milk oolong",
    "jinxuan", "alishan",
  ],
  white: ["white tea", "silver needle", "bai mu dan", "pai mu tan", "shou mei"],
  herbal: [
    "herbal", "tisane", "caffeine-free", "rooibos", "chamomile", "hibiscus",
    "echinacea", "mugwort", "valerian", "passionflower", "lemon balm",
    "peppermint tea", "spearmint tea", "ginger tea",
  ],
...
const CAFFEINE_PATTERNS = {
  "caffeine-free": [
    "caffeine-free", "caffeine free", "decaf", "herbal", "tisane", "rooibos",
    "chamomile", "hibiscus", "peppermint", "echinacea", "mugwort", "valerian",
  ],
  caffeinated: [
    "black tea", "green tea", "oolong", "white tea", "pu-erh", "matcha",
    "yerba mate", "chai", "keemun", "assam", "darjeeling", "ceylon",
    "sencha", "gyokuro", "longjing", "jinxuan", "alishan",
  ],
};
...
const FLAVOR_PATTERNS: Record<string, string[]> = {
  floral: [
    "jasmine", "rose", "lavender", "orchid", "honeysuckle", "flower",
    "chrysanthemum", "osmanthus", "violet", "hibiscus", "elderflower",
  ],
  fruity: [
    "berry", "apple", "peach", "mango", "fruit", "tropical", "strawberry",
    "raspberry", "blueberry", "cherry", "plum", "apricot", "pear", "grape",
    "passionfruit", "lychee", "guava", "papaya", "pineapple",
  ],
  citrus: [
    "lemon", "orange", "bergamot", "citrus", "grapefruit", "lime", "tangerine",
    "yuzu", "mandarin", "clementine",
  ],
  spicy: [
    "cinnamon", "ginger", "cardamom", "clove", "chai", "spice", "pepper",
    "turmeric", "nutmeg", "anise", "star anise", "masala", "aromatic spice",
    "zesty",
  ],
  minty: ["mint", "peppermint", "spearmint", "menthol"],
  earthy: [
    "earthy", "woody", "forest", "mushroom", "bark", "moss", "soil", "leather",
  ],
  nutty: [
    "almond", "hazelnut", "nutty", "chestnut", "walnut", "pecan", "cashew",
    "toasty", "roasted nut",
  ],
  smoky: ["smoke", "smoky", "lapsang", "campfire", "charcoal"],
  malty: ["malt", "malty", "breakfast", "assam", "biscuit", "bread", "toast"],
  sweet: [
    "honey", "caramel", "vanilla", "sweet", "maple", "sugar", "molasses",
    "toffee", "butterscotch", "sweetness",
  ],
...
const BODY_PATTERNS: Record<string, string[]> = {
  ...
  bold: ["bold", "strong", "robust", "full-bodied", "full bodied", "intense", "powerful"],
...
const HEALTH_PATTERNS: Record<string, string[]> = {
  antioxidant: ["antioxidant", "antioxidants", "polyphenol", "catechin", "egcg"],
  detox: ["detox", "cleanse", "cleansing", "purify", "purifying"],
  digestive: ["digestive", "digestion", "stomach", "belly", "tummy", "gut"],
  "immune-support": ["immune", "immunity", "cold", "flu", "vitamin c", "echinacea"],
...
const SOURCING_PATTERNS: Record<string, string[]> = {
  "high-mountain": ["high mountain", "high-mountain", "mountain", "altitude", "elevated"],
  organic: ["organic", "certified organic"],
  "single-estate": ["estate", "single estate", "single-estate", "garden", "single garden"],
};
...
const OCCASION_PATTERNS: Record<string, string[]> = {
  ...
  bedtime: [
    "sleepy", "sleep", "calming", "chamomile", "lavender", "bedtime", "night",
    "dream", "slumber", "valerian", "passionflower",
  ],
  relaxing: [
    "calm", "soothing", "relaxing", "peaceful", "zen", "tranquil", "serene",
    "meditation", "stress",
  ],
  energizing: [
    "energizing", "energy", "bright", "brisk", "bold", "strong", "invigorate",
    "uplift", "refresh",
  ],
};
